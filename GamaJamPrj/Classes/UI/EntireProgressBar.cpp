...
{
	// 새싹
	rose[0] = Sprite::create("SelectScene/bar_seed.png");
	rose[0]->setAnchorPoint(Vec2(0.5, 0.5));;
	rose[0]->setPosition(20, 600);
	this->addChild(rose[0]);

	// 발화?
	rose[1] = Sprite::create("SelectScene/bar_sprout.png");
	rose[1]->setAnchorPoint(Vec2(0.5, 0.5));
	rose[1]->setPosition(200, 600);
	this->addChild(rose[1]);
	// 장미
	rose[2] = Sprite::create("SelectScene/bar_rose.png");
	rose[2]->setAnchorPoint(Vec2(0.5, 0.5));
	rose[2]->setPosition(320, 600);
